...
> DSA focuses on daily analysis reports. Its built-in screening implementation references AlphaSift, while AlphaEvo covers strategy validation and evolution. Both upstream projects remain independently maintained references for extending the workflow.

| Project | Focus |
|---------|-------|
| [AlphaSift](https://github.com/ZhuLinsen/alphasift) | Reference project for DSA's built-in screening engine; it is no longer installed as a plugin |
